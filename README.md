...
| Source | 문서 수 | 청크 수 | 문서당 평균 청크 |
|--------|---------|---------|------------------|
| **웹페이지** (Pig Farming Site) | 12,799건 | 20,559개 | 1.61개 |
| **논문** (Semantic Scholar) | 1,006건 | 5,690개 | 5.66개 |
| **전체** | **13,805건** | **26,249개** | **1.90개** |

> 통계 확인: `python scripts/count_documents.py`
